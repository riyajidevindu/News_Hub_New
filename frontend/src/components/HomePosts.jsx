  ...
  return (
    <div className="w-full flex mt-8 space-x-4">
      ...
      <div className="w-[35%] h-[200px] flex justify-center items-center">
        <img src={IMAGEFOLDER+post.photo} alt="" className="h-full w-full object-cover"/>
      </div>
      {/* right */} 
      <div className="flex flex-col w-[65%]">
        <h1 className="text-xl font-bold md:mb-2 mb1 md:text-2xl">
          {post.title}
        </h1>
        ...
        <p className="text-sm break-words md:text-lg">
